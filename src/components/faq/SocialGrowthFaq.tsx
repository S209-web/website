...
const social_growth_faq_data: DataType[] = [
  {
    id: 1,
    question: "What's included in your social media management services?",
    answer: "Our social media management includes content calendar planning, post design & captions, hashtag & keyword optimization, scheduling & analytics reporting. We handle every detail from strategy to execution, ensuring consistent engagement and measurable growth across all your social platforms."
  }
];

const SocialGrowthFaq = () => {
          ...
          <div className="row">
            <div className="col-lg-6">
              <div className="cs_section_heading cs_style_1">
                ...
                <h2 className="cs_section_title anim_heading_title">
                  Frequently Asked Questions About Social & Community Growth
                </h2>
                <div className="cs_height_35 cs_height_lg_20"></div>
                <p className="cs_section_subtitle anim_text m-0">
                  Got questions about our social media management and community growth services? Here are answers to help you understand 
                  how we build authentic communities that drive real growth.
                </p>
              </div>
            ...
            <div className="col-lg-6">
              <div className="cs_accordians cs_style_1 anim_div_ShowDowns">
                {social_growth_faq_data.map((item) => (
                  <div 
                    key={item.id} 
...
export default SocialGrowthFaq;
