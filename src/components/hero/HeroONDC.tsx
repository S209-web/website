...
const hero_ondc: DataType = {
  ...
  description: `Transform your e-commerce operations with our comprehensive ONDC and retail media solutions. We help businesses navigate the open network for digital commerce while optimizing their retail media strategies for maximum visibility and growth across all major platforms.`,
  features: [
