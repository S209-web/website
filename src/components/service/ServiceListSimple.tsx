...
const services: ServiceItem[] = [
  ...
  { id: 2, title: 'Video Editing', image: '/assets/img/Video editing (2).png' },
  { id: 3, title: 'Social Media Management', image: '/assets/img/contentndservice.png' },
  { id: 4, title: 'AI-Based Content Creation', image: '/assets/img/contentndservice.png' },
  ...
  { id: 7, title: 'Performance Marketing', image: '/assets/img/results.jpg' },
  { id: 8, title: 'Influencer Marketing & PR', image: '/assets/img/GlobalMindset.png' },
  { id: 9, title: 'AI-SEO, GEO, AEO & Content Protection', image: '/assets/img/Global3D.png' },
  { id: 10, title: 'ONDC & Retail Media Ops', image: '/assets/img/ondcc.png' },
  { id: 11, title: 'CRO & Analytics Hub', image: '/assets/img/results.jpg' },
  { id: 12, title: 'UGC & Creator Commerce', image: '/assets/img/Magik Moments.png' },
  { id: 13, title: 'AI Automations', image: '/assets/img/automation.jpg' },
  { id: 14, title: 'Web & App Development with Custom Solutions', image: '/assets/img/creative_banner_img.jpg' },
