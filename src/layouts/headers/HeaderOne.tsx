...
import logo from "@/assets/img/logoheader.png"; // Make sure this path points to your actual logo image
import Logo_white from "@/assets/img/logoheader.png"; // And this one for the white version if it's different
                                        ...
                                        <a href="tel:(406)555-0120">
                                            <svg width="35" height="35" viewBox="0 0 18 19" fill="none"
                                                ...
                                                <path
                                                    ...
                                                    fill="white"></path>
                                                <path
                                                    d="M12.9672 8.93825L14.3493 8.70229C14.132 7.4326 13.5328 6.28277 12.6227 5.36889C11.6601 4.40633 10.4428 3.79957 9.10199 3.6123L8.90723 5.00184C9.94470 5.14791 10.8885 5.61609 11.6339 6.36142C12.338 7.06555 12.7987 7.95696 12.9672 8.93825Z"
                                                    fill="white"></path>
                                                <path
                                                    d="M15.1294 2.93344C13.5338 1.33791 11.5151 0.330398 9.28656 0.0195312L9.09180 1.40907C11.0169 1.67874 12.7623 2.55141 14.1406 3.92597C15.4477 5.23311 16.3054 6.88483 16.6163 8.70134L17.9983 8.46538C17.6350 6.36047 16.6425 4.45033 15.1294 2.93344Z"
                                                    fill="white"></path>
